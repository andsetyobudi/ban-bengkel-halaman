...
export default function TransferBarangPage() {
      ...
      <div className="flex flex-col gap-6">
        ...
        <Card>
          <CardContent className="flex flex-col items-center gap-3 py-16 text-center">
            ...
            <Button variant="outline" size="sm" className="mt-2" onClick={() => router.push("/adminpanel/transfer/riwayat")}>
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      fetch("/api/admin/initial-data")
        ...
        .catch(() => { })
      setSuccessInfo({
        fromName: getOutletName(fromOutletId),
        toName: getOutletName(toOutletId),
  ...
  const handleSuccessClose = () => {
    ...
    setSuccessInfo(null)
    router.push("/adminpanel/transfer/riwayat")
  }
      ...
      <Dialog open={successOpen} onOpenChange={setSuccessOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Transfer dari {successInfo?.fromName ?? getOutletName(fromOutletId)} ke {successInfo?.toName ?? getOutletName(toOutletId)} dengan {successInfo?.productCount ?? selectedItems.length} produk ({successInfo?.unitCount ?? totalItems} unit) telah berhasil dibuat dengan status <span className="font-medium text-foreground">Menunggu</span>.
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
            <Button variant="outline" onClick={handleReset}>
